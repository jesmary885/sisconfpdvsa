...
class UsuariosController extends Controller
{
    public function index(User $usuario,Anoreporte $anoreporte){
        ...
        $asignacionspaginate = Asignacion::where('user_id',$usuarioid)
                                        ->where('anoreporte_id',$anoreporteid)->paginate(4);
        ...
        return view('reportes.usuarios',compact('asignacionspaginate','usuario','plan_usuario_d','real_usuario_d','desviacion_usuario_d','cumplimiento_usuario_d','asignacions'));
    }
