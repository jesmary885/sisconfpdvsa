        ...
        foreach ($divisions as $division){
            ...
            foreach ($usuarios_divisions as $usuario_division){
                ...
                foreach ($asignacions_usuario as $asignacion_usuario){
                    ...
                    $plan_recopilacion_d = ((($dias_real_recopilacion_d) * 100) / ($asignacion_usuario->plan_dias_recopilacion)) * 0.20;
                    }
                    ...
                    $plan_inf_d = ((($dias_real_inf_d) * 100) / ($asignacion_usuario->plan_dias_inf)) * 0.40;
                    }
                    ...
                    $plan_divulgacion_d = ((($dias_real_divulgacion_d) * 100) / ($asignacion_usuario->plan_dias_divulgacion)) * 0.20;
                    }
                    ...
                    $plan_carga_d = ((($dias_real_carga_d) * 100) / ($asignacion_usuario->plan_dias_carga)) * 0.10;
                    }
