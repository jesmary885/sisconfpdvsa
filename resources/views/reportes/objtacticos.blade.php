    ...
    <div class="card">
        <div class="card-body">
            ...
            @else
                ...
                <div class="flex py-4">
                    <div class="px-4">
                        <a href="{{route('listado.objtactico')}}" class="text-gray-600 text-lg font-bold hover:text-red-600 text">Regresar</a>
                    </div>
                    <div class="px-4">
                        <a href="{{url('consultas_objtacticos/export-excel')}}" class="text-gray-600 text-lg font-bold hover:text-red-600 text-right">Exportar a excel</a>
                    </div>
                </div>
            @endif
        </div>
